...
import { Phone, ArrowRight, ChevronDown, Stethoscope, Sparkles } from "lucide-react";
    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-brand-950">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-32">
        <div className="max-w-2xl">
          ...
          <motion.p
            className="mt-6 text-lg md:text-xl text-white/60 font-body leading-relaxed max-w-lg"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* Trust badges */}
          <motion.div
            className="mt-16 flex items-center gap-8 text-white/40 text-sm font-body"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
